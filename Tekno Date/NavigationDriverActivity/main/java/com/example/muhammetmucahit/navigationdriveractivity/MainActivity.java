...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.add(R.id.frameLayout_content, fragmentHome);
        ft.commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_mainPage) {
            FragmentHome fragmentHome = new FragmentHome();
            ft.replace(R.id.frameLayout_content, fragmentHome);
            ft.commit();
        } else if (id == R.id.nav_android) {
            FragmentAndroid fragmentAndroid = new FragmentAndroid();
            ft.replace(R.id.frameLayout_content, fragmentAndroid);
            ft.commit();
        } else if (id == R.id.nav_ios) {
            FragmentIOS fragmentIOS = new FragmentIOS();
            ft.replace(R.id.frameLayout_content, fragmentIOS);
            ft.commit();
        } else if (id == R.id.nav_windowsphone) {
            FragmentWindowsPhone fragmentWindowsPhone = new FragmentWindowsPhone();
            ft.replace(R.id.frameLayout_content, fragmentWindowsPhone);
            ft.commit();
